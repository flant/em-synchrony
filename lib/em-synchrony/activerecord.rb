    ...
    module Core
      ...
      module ClassMethods
        def initialize_find_by_cache
          self.find_by_statement_cache = ::EventMachine::Synchrony::ActiveRecord::V4_2::Core::StatementCache.new
        end
      end # ClassMethods
    end # Core
...
ActiveSupport.on_load(:active_record) do
  ActiveRecord::Base.send(:include, EventMachine::Synchrony::ActiveRecord::Common::AttributeMethods)
  ...
  ActiveRecord::ConnectionAdapters::ConnectionPool.send(:prepend,
      EventMachine::Synchrony::ActiveRecord::Common::ConnectionAdapters::ConnectionPool)

  case ActiveRecord.version.to_s
  when /^4.2/
    ActiveRecord::Base.send(:include, EventMachine::Synchrony::ActiveRecord::V4_2::Core)
    ActiveRecord::ConnectionAdapters::AbstractAdapter.send(:prepend,
        EventMachine::Synchrony::ActiveRecord::V4_2::ConnectionAdapters::AbstractAdapter)
  end
end
